...
DATASET_PATH = '/usr/local/data/xujing/DistDiff/data/{}'
...
class StandardDataLoader:
    ...
    def load_dataset(self):
        ...
        elif self.args.dataset in ["caltech-101", "rock_minerals", "m_rock"]:
    ...
    def caltech101_load(self):
        ...
        # assert len(string_classnames) == 15
